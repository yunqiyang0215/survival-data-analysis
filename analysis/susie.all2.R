...
pheno = readRDS("/gpfs/data/stephens-lab/uk-biobank-survival/yunqi/survpheno/ukb_asthma_self_report/survival-data-analysis/data/surv_pheno/surv_all_asthma.rds")
covar = read.table("/gpfs/data/stephens-lab/uk-biobank-survival/yunqi/survpheno/ukb_asthma_self_report/survival-data-analysis/data/gwas_logistic/covar.txt",
                   header = TRUE)
...
saveRDS(res, paste0("/gpfs/data/stephens-lab/uk-biobank-survival/yunqi/survpheno/ukb_asthma_self_report/survival-data-analysis/result202504/all/fit.susie.", region, ".rds"))
