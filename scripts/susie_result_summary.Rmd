...
```{r}
region = c("chr11_75500001_77400000", 
...
analysis = c("AA", "AOA", "COA", "AA", "COA", "AA", "AA", "AOA", "AA")
summary = data.frame(cbind(region, analysis))
...
```{r}
colnames(cs_summary) = c("region", "analysis", "size", "min.abs.corr")
