...
pheno = readRDS("/gpfs/data/stephens-lab/uk-biobank-survival/yunqi/survpheno/ukb_asthma_self_report/survival-data-analysis/data/surv_pheno/surv_aoa.rds")
covar = read.table("/gpfs/data/stephens-lab/uk-biobank-survival/yunqi/survpheno/ukb_asthma_self_report/survival-data-analysis/data/gwas_logistic/covar_aoa.txt",
                   header = TRUE)
...
saveRDS(res, paste0("/gpfs/data/stephens-lab/uk-biobank-survival/yunqi/survpheno/ukb_asthma_self_report/survival-data-analysis/result202504/aoa/fit.susie.", region, ".rds"))
